define(['jquery', 'underscore', 'mustache', 'backbone', 'text!templates/profile/profileTemplate.html'], function($, _, Mustache, Backbone, profileTemplate) {
	...
	var ProfileView = Backbone.View.extend({
		...
		render : function() {
			...
			this.$headerTitle.parent().addClass("fadeInLeftBig").removeClass("animated");
			this.$el.addClass("slideInLeft").removeClass("animated");
			...
			get_profile(function(data) {
				...
				loader('hide');
				_this.$headerTitle.parent().addClass("animated");
				_this.$el.addClass("animated");
			});
