...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    scannerAlpha = 0;
    possibleResultPoints = new HashSet<ResultPoint>(125);
  }
...
//    canvas.drawRect(0, frame.bottom + 1, width, height, paint);
    ...
    paint.setColor(resultBitmap != null ? resultColor : maskColor);
    canvas.drawRect(0, 0, width, frame.top-150, paint);
    canvas.drawRect(0, frame.top-150, frame.left, frame.bottom + 1, paint);
    canvas.drawRect(frame.right + 1, frame.top-150, width, frame.bottom + 1, paint);
    canvas.drawRect(0, frame.bottom + 1, width, height, paint);
